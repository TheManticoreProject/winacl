...
// Control flag bit masks, matching the little-endian wire layout used by
// MS-DTYP and winnt.h (the SECURITY_DESCRIPTOR_CONTROL / SE_* values). The
// MS-DTYP packet diagram numbers bits from the most-significant end ("bit 0"
// is the MSB), but the value actually serialized to the wire uses these
// masks, e.g. SE_SELF_RELATIVE = 0x8000 and SE_DACL_PRESENT = 0x0004.
const (
